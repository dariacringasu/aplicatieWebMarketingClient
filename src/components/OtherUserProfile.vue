...
const response = await fetch("/api/client/getUserById?userId="+userId);
    ...
    <section style="margin-top: 1%; margin-left: 20%;">
      ...
      <div class="container">
          ...
          <div class="videos">
            ...
            <table v-if="videos && videos.length > 0" class="content-table" id="myTable">
          <thead>
            <tr>
              <th></th>
              <th>Title</th>
        ...
        <div v-else class="noVideos"> no posted videos yet</div>
